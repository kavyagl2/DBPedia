...
# Set PYTHONPATH
os.environ['PYTHONPATH'] = "D:\\NABU-master\\NABU-master\\src"
...
subprocess.run([
    ...
    "--hidden_size", "16", "--filter_size", "16", "--beam_size", "5",
    "--mode", "train", "--beam_alpha", "0.1", "--enc_layers", "1",
    "--dec_layers", "1", "--num_heads", "1", "--sentencepiece", "True",
    "--steps", "10000", "--eval_steps", "1000", "--checkpoint", "1000",
    "--alpha", "0.2", "--dropout", "0.2", "--reg_scale", "0.0",
    "--decay", "True", "--decay_steps", "5000", "--lang", "eng",
    "--debug_mode", "False", "--eval", "data/processed_data/eng/eval_src",
